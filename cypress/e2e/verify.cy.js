describe('verify', () => {
  it('should successfully verify account', () => {
    ...
    cy.request({
      method: 'GET',
      url: `https://api.twilio.com/2010-04-01/Accounts/${Cypress.env('twillio_account_sid')}/Messages.json?To=8329643224&From=%2B13605940441&__referrer=runtime&Format=json&PageSize=50&Page=0`,
      auth: {
      ...
      .its('body').then((body) => {
        cy.wait(3000);
        const otpcode = body.messages[0].body.split('is ')[1];
        cy.log(otpcode);
